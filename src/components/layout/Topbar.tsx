  ...
  return (
    <header className="h-16 bg-[#FFFFFF] border-b border-[#E5E7EB] flex items-center justify-between px-4 lg:px-6 gap-2 flex-shrink-0">
      ...
      <div className="flex items-center gap-1 lg:gap-3">
        ...
        <button onClick={onAgent} className="h-8 pl-2.5 pr-3 rounded-full bg-[#5e6ad2] text-white text-sm font-medium flex items-center gap-1.5 hover:bg-[#4F58C9] transition-colors flex-shrink-0" title="Agent 对话模式：多轮对话生成图片">
          ...
          <span className="whitespace-nowrap">Agent 对话</span>
        </button>
      </div>
    </header>
  );
